...
from toolkit.datasets import OTBDataset, UAVDataset, LaSOTDataset, \
        VOTDataset, NFSDataset, VOTLTDataset,TCDataset
...
parser.add_argument('--dataset', '-d', type=str, default='VOT2016',
                    help='dataset name')
...
def main():
    ...
    if 'OTB' in args.dataset:
        ...
        dataset = TCDataset(args.dataset, root)
        dataset.set_tracker(tracker_dir, trackers)
        benchmark = OPEBenchmark(dataset)
        success_ret = {}
        index=0
