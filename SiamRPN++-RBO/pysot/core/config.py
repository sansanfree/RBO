...
__C.DATASET.NAMES = ('VID', 'YOUTUBEBB', 'COCO', 'DET','GOT')
...
__C.DATASET.GOT = CN()
__C.DATASET.GOT.ROOT = 'train_dataset/GOT10k511/got10k/crop511'
__C.DATASET.GOT.ANNO = 'train_dataset/GOT10k511/got10k/all.json'
